    ...
    >
      <div className="max-w-6xl mx-auto">
        <motion.div variants={fadeUpStagger} className="grid md:grid-cols-3 gap-8 mb-8">
          <motion.div variants={fadeUpItem}>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-semibold text-text-primary">El Colectivo</span>
            </div>
              ...
              {[
                ...
                <motion.li key={label} whileHover={{ x: 3 }}>
                  <a
                    ...
                    className="text-xs text-text-secondary hover:text-bright transition-colors"
                  >
                    {label}
                  </a>
                </motion.li>
        ...
        >
          ...
          >
            Hecho con <Heart className="w-3 h-3 text-bright" /> por Eternum
          </motion.p>
